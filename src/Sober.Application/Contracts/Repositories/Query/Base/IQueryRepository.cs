...
namespace Sober.Application.Contracts.Repositories.Query.Base
{
    public interface IQueryRepository<TEntity> where TEntity : class
    {
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TEntity>(string sql, Func<TFirst, TSecond, TEntity> map, DynamicParameters parameters, string splitters, bool isProcedure = false)
            where TFirst : class
            where TSecond : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TThird, TFourth, TFifth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TEntity> map,
            string splitters, bool isProcedure = false)
            where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
        ...
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TThird, TFourth, TFifth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TEntity> map,
            DynamicParameters parameters, string splitters , bool isProcedure = false)
            where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TEntity> map,
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEntity>(string sql, 
            Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEntity> map,
            string splitters, bool isProcedure = false)
            where TFirst : class
            where TSecond : class
            where TThird : class
        ...
        /// <summary>
        /// Get Single Mapped Data using SQL Query or Procedure with dapper parameters from an entity
        /// </summary>
        /// <typeparam name="TFirst"></typeparam>
        /// <typeparam name="TSecond"></typeparam>
        /// <typeparam name="TEntity"></typeparam>
        ...
        /// <returns></returns>
        /// 
        Task<long> SingleCountAsync(string sql, DynamicParameters parameters, bool isProcedure = false);

        /// <summary>
        /// Get Count of  Data using SQL Query or Procedure with dapper parameters from an entity
        /// </summary>
        /// <param name="sql"></param>
        /// <param name="map"></param>
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        /// 
        Task<TEntity> SingleAsync<TFirst, TSecond, TEntity>(string sql, Func<TFirst, TSecond, TEntity> map, string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity?> SingleAsync<TFirst, TSecond, TEntity>(string sql, Func<TFirst, TSecond, TEntity> map, DynamicParameters parameters, string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity> SingleAsync<TFirst, TSecond, TThird, TEntity>(string sql, Func<TFirst, TSecond, TThird, TEntity> map, string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TThird : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity> SingleAsync<TFirst, TSecond, TThird, TEntity>(string sql, Func<TFirst, TSecond, TThird, TEntity> map, DynamicParameters parameters, string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TThird : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity?> SingleAsync<TFirst, TSecond, TThird, TFourth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TEntity> map, 
            DynamicParameters parameters, string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
            where TEntity : class;
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity> SingleAsync<TFirst, TSecond, TThird, TFourth, TFifth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TEntity> map,
            string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
            where TFifth : class
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity> SingleAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TEntity> map, 
            string splitters = "Id",bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<TEntity> SingleAsync<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TSixth, TSeventh, TEntity> map,
            string splitters = "Id", bool isProcedure = false) where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
